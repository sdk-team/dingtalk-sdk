...
class GetOapiImChatbotRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiImChatbotRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiImChatbotParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
