...
class GetOapiIndustryUserRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiIndustryUserRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiIndustryUserParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
