...
class CreateOapiEduCourseRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateOapiEduCourseRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateOapiEduCourseParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
