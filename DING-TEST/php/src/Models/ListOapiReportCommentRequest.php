...
class ListOapiReportCommentRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiReportCommentRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiReportCommentParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ListOapiReportCommentParams
     */
    public $params;
