...
class UpdateOapiChatThemeRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateOapiChatThemeRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateOapiChatThemeParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
