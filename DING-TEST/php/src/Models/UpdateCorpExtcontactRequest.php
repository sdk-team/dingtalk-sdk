...
class UpdateCorpExtcontactRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateCorpExtcontactRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateCorpExtcontactParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var UpdateCorpExtcontactParams
     */
    public $params;
