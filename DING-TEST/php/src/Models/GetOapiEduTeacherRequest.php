...
class GetOapiEduTeacherRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduTeacherRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduTeacherParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
