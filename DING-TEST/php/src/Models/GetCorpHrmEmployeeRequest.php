...
class GetCorpHrmEmployeeRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetCorpHrmEmployeeRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetCorpHrmEmployeeParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
