...
class SimplelistOapiReportRequest extends Model {
    ...
    /**
     * @param array $map
     * @return SimplelistOapiReportRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = SimplelistOapiReportParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var SimplelistOapiReportParams
     */
    public $params;
