...
class CreateOapiEduHomeworkRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateOapiEduHomeworkRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateOapiEduHomeworkParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CreateOapiEduHomeworkParams
     */
    public $params;
