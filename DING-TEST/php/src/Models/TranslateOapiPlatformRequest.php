...
class TranslateOapiPlatformRequest extends Model {
    ...
    /**
     * @param array $map
     * @return TranslateOapiPlatformRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = TranslateOapiPlatformParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var TranslateOapiPlatformParams
     */
    public $params;
