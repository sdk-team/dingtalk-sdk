...
class QueryOapiRetailSellerRequest extends Model {
    ...
    /**
     * @param array $map
     * @return QueryOapiRetailSellerRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = QueryOapiRetailSellerParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var QueryOapiRetailSellerParams
     */
    public $params;
