...
class GetOapiExtcontactRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiExtcontactRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiExtcontactParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
