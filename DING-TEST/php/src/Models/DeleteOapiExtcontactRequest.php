...
class DeleteOapiExtcontactRequest extends Model {
    ...
    /**
     * @param array $map
     * @return DeleteOapiExtcontactRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = DeleteOapiExtcontactParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var DeleteOapiExtcontactParams
     */
    public $params;
