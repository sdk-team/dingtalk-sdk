...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\ListOapiHealthStepinfoResponseBody\stepinfoList;

class ListOapiHealthStepinfoResponseBody extends Model {
    protected $_name = [
        'errcode' => 'errcode',
        'errmsg' => 'errmsg',
    ...
    /**
     * @param array $map
     * @return ListOapiHealthStepinfoResponseBody
     */
