...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\CreateOapiDingTaskParams\taskSendVO;

class CreateOapiDingTaskParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return CreateOapiDingTaskParams
     */
