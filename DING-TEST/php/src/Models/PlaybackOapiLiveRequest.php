...
class PlaybackOapiLiveRequest extends Model {
    ...
    /**
     * @param array $map
     * @return PlaybackOapiLiveRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = PlaybackOapiLiveParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
