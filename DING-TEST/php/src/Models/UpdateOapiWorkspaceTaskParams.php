...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\UpdateOapiWorkspaceTaskParams\task;

class UpdateOapiWorkspaceTaskParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return UpdateOapiWorkspaceTaskParams
     */
