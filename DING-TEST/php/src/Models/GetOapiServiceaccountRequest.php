...
class GetOapiServiceaccountRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiServiceaccountRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiServiceaccountParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetOapiServiceaccountParams
     */
    public $params;
