...
class GetOapiEduTypeDataRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduTypeDataRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduTypeDataParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
