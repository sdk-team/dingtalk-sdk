...
class StartOapiEduCourseRequest extends Model {
    ...
    /**
     * @param array $map
     * @return StartOapiEduCourseRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = StartOapiEduCourseParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
