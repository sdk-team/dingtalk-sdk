...
class GetrolegroupOapiRoleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetrolegroupOapiRoleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetrolegroupOapiRoleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetrolegroupOapiRoleParams
     */
    public $params;
