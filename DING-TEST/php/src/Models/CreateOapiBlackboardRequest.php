...
class CreateOapiBlackboardRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateOapiBlackboardRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateOapiBlackboardParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CreateOapiBlackboardParams
     */
    public $params;
