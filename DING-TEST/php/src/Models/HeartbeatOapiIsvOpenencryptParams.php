...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\HeartbeatOapiIsvOpenencryptParams\topKmsHeartbeat;

class HeartbeatOapiIsvOpenencryptParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return HeartbeatOapiIsvOpenencryptParams
     */
