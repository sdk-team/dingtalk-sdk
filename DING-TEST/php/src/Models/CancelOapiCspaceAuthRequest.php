...
class CancelOapiCspaceAuthRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CancelOapiCspaceAuthRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CancelOapiCspaceAuthParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CancelOapiCspaceAuthParams
     */
    public $params;
