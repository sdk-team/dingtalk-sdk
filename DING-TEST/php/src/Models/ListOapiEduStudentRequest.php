...
class ListOapiEduStudentRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiEduStudentRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiEduStudentParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
