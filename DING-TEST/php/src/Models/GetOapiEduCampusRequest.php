...
class GetOapiEduCampusRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduCampusRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduCampusParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
