...
class GetOapiEduMainDataRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduMainDataRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduMainDataParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
