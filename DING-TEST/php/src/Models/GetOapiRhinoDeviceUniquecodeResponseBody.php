...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\GetOapiRhinoDeviceUniquecodeResponseBody\model;

class GetOapiRhinoDeviceUniquecodeResponseBody extends Model {
    protected $_name = [
        'success' => 'success',
        'model' => 'model',
        'errmsg' => 'errmsg',
    ...
    /**
     * @param array $map
     * @return GetOapiRhinoDeviceUniquecodeResponseBody
     */
