...
class SimplelistOapiRoleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return SimplelistOapiRoleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = SimplelistOapiRoleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
