...
class GetCorpExtcontactRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetCorpExtcontactRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetCorpExtcontactParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
