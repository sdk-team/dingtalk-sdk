...
class AddOapiAtsJobDeliverRequest extends Model {
    ...
    /**
     * @param array $map
     * @return AddOapiAtsJobDeliverRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = AddOapiAtsJobDeliverParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var AddOapiAtsJobDeliverParams
     */
    public $params;
