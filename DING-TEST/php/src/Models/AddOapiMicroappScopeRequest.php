...
class AddOapiMicroappScopeRequest extends Model {
    ...
    /**
     * @param array $map
     * @return AddOapiMicroappScopeRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = AddOapiMicroappScopeParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var AddOapiMicroappScopeParams
     */
    public $params;
