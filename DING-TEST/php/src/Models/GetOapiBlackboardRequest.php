...
class GetOapiBlackboardRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiBlackboardRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiBlackboardParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
