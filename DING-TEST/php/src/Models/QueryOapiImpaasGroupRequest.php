...
class QueryOapiImpaasGroupRequest extends Model {
    ...
    /**
     * @param array $map
     * @return QueryOapiImpaasGroupRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = QueryOapiImpaasGroupParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var QueryOapiImpaasGroupParams
     */
    public $params;
