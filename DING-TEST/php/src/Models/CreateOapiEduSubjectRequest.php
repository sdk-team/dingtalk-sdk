...
class CreateOapiEduSubjectRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateOapiEduSubjectRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateOapiEduSubjectParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CreateOapiEduSubjectParams
     */
    public $params;
