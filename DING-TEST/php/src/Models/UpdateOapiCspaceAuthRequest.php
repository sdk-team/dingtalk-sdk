...
class UpdateOapiCspaceAuthRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateOapiCspaceAuthRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateOapiCspaceAuthParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var UpdateOapiCspaceAuthParams
     */
    public $params;
