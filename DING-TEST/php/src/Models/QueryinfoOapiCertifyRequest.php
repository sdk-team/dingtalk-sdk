...
class QueryinfoOapiCertifyRequest extends Model {
    ...
    /**
     * @param array $map
     * @return QueryinfoOapiCertifyRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = QueryinfoOapiCertifyParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var QueryinfoOapiCertifyParams
     */
    public $params;
