...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\AuthappcloseOapiOrgOpenencryptParams\topAuthMicroAppClose;

class AuthappcloseOapiOrgOpenencryptParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return AuthappcloseOapiOrgOpenencryptParams
     */
