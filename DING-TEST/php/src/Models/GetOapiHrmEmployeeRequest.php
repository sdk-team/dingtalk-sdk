...
class GetOapiHrmEmployeeRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiHrmEmployeeRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiHrmEmployeeParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
