...
class DeleteOapiRoleVisibleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return DeleteOapiRoleVisibleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = DeleteOapiRoleVisibleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var DeleteOapiRoleVisibleParams
     */
    public $params;
