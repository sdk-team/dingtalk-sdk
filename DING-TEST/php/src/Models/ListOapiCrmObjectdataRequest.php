...
class ListOapiCrmObjectdataRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiCrmObjectdataRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiCrmObjectdataParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ListOapiCrmObjectdataParams
     */
    public $params;
