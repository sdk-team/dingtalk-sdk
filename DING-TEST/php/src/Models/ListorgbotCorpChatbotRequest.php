...
class ListorgbotCorpChatbotRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListorgbotCorpChatbotRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListorgbotCorpChatbotParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ListorgbotCorpChatbotParams
     */
    public $params;
