...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\ListOapiRhinoHumanresEmployeeProductionteamResponseBody;

use AlibabaCloud\Tea\Model;

use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\ListOapiRhinoHumanresEmployeeProductionteamResponseBody\corpEmployeeInfo\productionTeamList;
...
class corpEmployeeInfo extends Model {
    protected $_name = [
        ...
        'bucId' => 'buc_id',
        'imgUrl' => 'img_url',
        'productionTeamList' => 'production_team_list',
        'name' => 'name',
        'tenantId' => 'tenant_id',
        'buMail' => 'bu_mail',
        'id' => 'id',
    ...
    public function toMap() {
        ...
        if (null !== $this->productionTeamList) {
            $res['production_team_list'] = [];
            if(null !== $this->productionTeamList && is_array($this->productionTeamList)){
                $n = 0;
                foreach($this->productionTeamList as $item){
                    $res['production_team_list'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
        if (null !== $this->name) {
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['production_team_list'])){
            if(!empty($map['production_team_list'])){
                $model->productionTeamList = [];
                $n = 0;
                foreach($map['production_team_list'] as $item) {
                    $model->productionTeamList[$n++] = null !== $item ? productionTeamList::fromMap($item) : $item;
                }
            }
        }
        if(isset($map['name'])){
