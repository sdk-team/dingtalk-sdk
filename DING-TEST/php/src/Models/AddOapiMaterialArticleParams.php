...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\AddOapiMaterialArticleParams\article;

class AddOapiMaterialArticleParams extends Model {
    protected $_name = [
        'article' => 'article',
        'unionid' => 'unionid',
    ];
    ...
    /**
     * @param array $map
     * @return AddOapiMaterialArticleParams
     */
