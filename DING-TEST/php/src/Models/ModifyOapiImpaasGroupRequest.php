...
class ModifyOapiImpaasGroupRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ModifyOapiImpaasGroupRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ModifyOapiImpaasGroupParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ModifyOapiImpaasGroupParams
     */
    public $params;
