...
class AddrolegroupOapiRoleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return AddrolegroupOapiRoleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = AddrolegroupOapiRoleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var AddrolegroupOapiRoleParams
     */
    public $params;
