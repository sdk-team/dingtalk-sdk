...
class GetOapiCollectionFormRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiCollectionFormRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiCollectionFormParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetOapiCollectionFormParams
     */
    public $params;
