...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\CheckOapiSmartworkHrmMasterResponseBody;

use AlibabaCloud\Tea\Model;

use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\CheckOapiSmartworkHrmMasterResponseBody\result\failResult;
...
class result extends Model {
    ...
    /**
     * @description 保存失败的结果，全部成功是为空
     * @var array
     */
    public $failResult;

    /**
     * @description 是否全部处理成功
     * @var bool
     */
    public $allSuccess;
