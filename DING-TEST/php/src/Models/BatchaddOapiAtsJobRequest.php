...
class BatchaddOapiAtsJobRequest extends Model {
    ...
    /**
     * @param array $map
     * @return BatchaddOapiAtsJobRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = BatchaddOapiAtsJobParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
