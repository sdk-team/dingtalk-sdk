...
class AddOapiMaterialNewsRequest extends Model {
    ...
    /**
     * @param array $map
     * @return AddOapiMaterialNewsRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = AddOapiMaterialNewsParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
