...
class ListOapiMaterialNewsRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiMaterialNewsRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiMaterialNewsParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ListOapiMaterialNewsParams
     */
    public $params;
