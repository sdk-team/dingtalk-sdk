...
class GetOapiEduStudentRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduStudentRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduStudentParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
