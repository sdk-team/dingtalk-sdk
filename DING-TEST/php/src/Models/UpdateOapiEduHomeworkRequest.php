...
class UpdateOapiEduHomeworkRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateOapiEduHomeworkRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateOapiEduHomeworkParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var UpdateOapiEduHomeworkParams
     */
    public $params;
