...
class ListOapiIndustryUserRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiIndustryUserRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiIndustryUserParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ListOapiIndustryUserParams
     */
    public $params;
