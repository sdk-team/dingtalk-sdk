...
class GetOapiKacDatavGroupRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiKacDatavGroupRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiKacDatavGroupParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetOapiKacDatavGroupParams
     */
    public $params;
