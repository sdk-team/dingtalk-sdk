...
class AddOapiServiceaccountRequest extends Model {
    ...
    /**
     * @param array $map
     * @return AddOapiServiceaccountRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = AddOapiServiceaccountParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var AddOapiServiceaccountParams
     */
    public $params;
