...
class SearchOapiEduFaceRequest extends Model {
    ...
    /**
     * @param array $map
     * @return SearchOapiEduFaceRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = SearchOapiEduFaceParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
