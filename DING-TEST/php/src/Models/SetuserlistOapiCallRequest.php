...
class SetuserlistOapiCallRequest extends Model {
    ...
    /**
     * @param array $map
     * @return SetuserlistOapiCallRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = SetuserlistOapiCallParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
