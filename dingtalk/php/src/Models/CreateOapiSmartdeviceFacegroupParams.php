...
class CreateOapiSmartdeviceFacegroupParams extends Model {
    protected $_name = [
        'bizId' => 'biz_id',
        'title' => 'title',
    ...
    /**
     * @param array $map
     * @return CreateOapiSmartdeviceFacegroupParams
     */
    ...
    /**
     * @description 业务id【不区分大小写】：调用方内保证唯一即可，可容纳23个字符，推荐前三个字符表示业务编号，留19个字符存储业务的记录id
     * @var string
     */
    public $bizId;
