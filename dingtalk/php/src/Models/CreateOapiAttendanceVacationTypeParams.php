...
class CreateOapiAttendanceVacationTypeParams extends Model {
    protected $_name = [
    ...
    public function validate() {
        Model::validateRequired('leaveName', $this->leaveName, true);
        Model::validateRequired('leaveViewUnit', $this->leaveViewUnit, true);
        Model::validateRequired('bizType', $this->bizType, true);
        Model::validateRequired('naturalDayLeave', $this->naturalDayLeave, true);
        Model::validateRequired('opUserid', $this->opUserid, true);
        Model::validateRequired('hoursInPerDay', $this->hoursInPerDay, true);
    }
    ...
    /**
     * @param array $map
     * @return CreateOapiAttendanceVacationTypeParams
     */
