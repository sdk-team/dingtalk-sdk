...
class AddOapiEduCourseParticipantParams extends Model {
    protected $_name = [
        'opUserid' => 'op_userid',
    ...
    /**
     * @param array $map
     * @return AddOapiEduCourseParticipantParams
     */
    ...
    /**
     * @description 参与方角色。student：学生、guardian: 监护人、teacher：老师（注意：授课老师只支持通过课程创建和修改接口，进行添加和修改）
     * @var string
     */
    public $role;
