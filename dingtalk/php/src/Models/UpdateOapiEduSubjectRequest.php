...
class UpdateOapiEduSubjectRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateOapiEduSubjectRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateOapiEduSubjectParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var UpdateOapiEduSubjectParams
     */
    public $params;
