...
class GetOapiWorkspaceTaskRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiWorkspaceTaskRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiWorkspaceTaskParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetOapiWorkspaceTaskParams
     */
    public $params;
