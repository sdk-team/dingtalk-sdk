...
class GetOapiProcessFormRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiProcessFormRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiProcessFormParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
