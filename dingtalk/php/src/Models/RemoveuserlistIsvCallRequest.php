...
class RemoveuserlistIsvCallRequest extends Model {
    ...
    /**
     * @param array $map
     * @return RemoveuserlistIsvCallRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = RemoveuserlistIsvCallParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var RemoveuserlistIsvCallParams
     */
    public $params;
