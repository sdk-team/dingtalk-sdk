...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\ModjobinfoCorpHrmEmployeeParams\hrmApiJobModel;

class ModjobinfoCorpHrmEmployeeParams extends Model {
    protected $_name = [
        'opUserid' => 'op_userid',
    ...
    /**
     * @param array $map
     * @return ModjobinfoCorpHrmEmployeeParams
     */
