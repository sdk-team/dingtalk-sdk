...
class GetOapiEduGuardianRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduGuardianRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduGuardianParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
