...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\GetCorpExtcontactResponseBody\result;
...
class result extends Model {
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['ext_attr'])){
            $model->extAttr = $map['ext_attr'];
        }
        return $model;
    }
    /**
