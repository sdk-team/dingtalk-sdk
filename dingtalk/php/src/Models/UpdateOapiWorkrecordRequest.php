...
class UpdateOapiWorkrecordRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateOapiWorkrecordRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateOapiWorkrecordParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var UpdateOapiWorkrecordParams
     */
    public $params;
