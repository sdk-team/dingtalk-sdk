...
class QueryOapiChatBanwordsRequest extends Model {
    ...
    /**
     * @param array $map
     * @return QueryOapiChatBanwordsRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = QueryOapiChatBanwordsParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var QueryOapiChatBanwordsParams
     */
    public $params;
