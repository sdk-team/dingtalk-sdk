...
class ListOapiEduTeacherRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiEduTeacherRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiEduTeacherParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
