...
class GetOapiConferenceRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiConferenceRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiConferenceParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
