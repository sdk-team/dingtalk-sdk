...
class ListOapiCalendarRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiCalendarRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiCalendarParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
