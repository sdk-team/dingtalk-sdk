...
class GetuserstatusCorpHealthStepinfoRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetuserstatusCorpHealthStepinfoRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetuserstatusCorpHealthStepinfoParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetuserstatusCorpHealthStepinfoParams
     */
    public $params;
