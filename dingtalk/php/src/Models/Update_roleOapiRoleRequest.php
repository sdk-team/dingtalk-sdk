...
class Update_roleOapiRoleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return Update_roleOapiRoleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = Update_roleOapiRoleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
