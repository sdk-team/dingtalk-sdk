...
class UpdateOapiDepartmentParams extends Model {
    protected $_name = [
        'id' => 'id',
    ...
    /**
     * @param array $map
     * @return UpdateOapiDepartmentParams
     */
    ...
    /**
     * @description 如果有新人加入部门是否会自动加入部门群
     * @var bool
     */
    public $autoAddUser;

    /**
     * @description 是否创建一个关联此部门的企业群
     * @var bool
     */
    ...
    /**
     * @description 本门群是否包含子部门
     * @var bool
     */
    public $groupContainSubDept;

    /**
     * @description 部门群是否包含外包部门
     * @var bool
     */
    public $groupContainOuterDept;

    /**
     * @description 部门群是否包含隐藏部门
     * @var bool
     */
