...
class InstallCorpChatbotRequest extends Model {
    ...
    /**
     * @param array $map
     * @return InstallCorpChatbotRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = InstallCorpChatbotParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
