...
class ListbytypeOapiReportStatisticsParams extends Model {
    protected $_name = [
        'reportId' => 'report_id',
        'type' => 'type',
        'offset' => 'offset',
    ...
    /**
     * @param array $map
     * @return ListbytypeOapiReportStatisticsParams
     */
    ...
    /**
     * @description 查询类型 0:已读人员列表 1:评论人员列表 2:点赞人员列表
     * @var int
     */
    public $type;
    ...
    /**
     * @description 分页参数，每页大小，最多传100，默认值为100
     * @var int
     */
    public $size;
