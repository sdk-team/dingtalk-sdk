...
class CreateOapiCrmGroupRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateOapiCrmGroupRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateOapiCrmGroupParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
