...
class DeleteOapiBlackboardRequest extends Model {
    ...
    /**
     * @param array $map
     * @return DeleteOapiBlackboardRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = DeleteOapiBlackboardParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var DeleteOapiBlackboardParams
     */
    public $params;
