...
class JoinOapiEduCourseRequest extends Model {
    ...
    /**
     * @param array $map
     * @return JoinOapiEduCourseRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = JoinOapiEduCourseParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
