...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\ListOapiCrmObjectdataContactResponseBody\resultList;

class ListOapiCrmObjectdataContactResponseBody extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return ListOapiCrmObjectdataContactResponseBody
     */
