...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\UpdatevariablesSmartworkBpmsProcessinstanceParams\variables;

class UpdatevariablesSmartworkBpmsProcessinstanceParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return UpdatevariablesSmartworkBpmsProcessinstanceParams
     */
