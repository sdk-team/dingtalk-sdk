...
class TransformOapiChatRequest extends Model {
    ...
    /**
     * @param array $map
     * @return TransformOapiChatRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = TransformOapiChatParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
