...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\ListOapiCrmObjectdataCustomerResponseBody\resultList;

class ListOapiCrmObjectdataCustomerResponseBody extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return ListOapiCrmObjectdataCustomerResponseBody
     */
