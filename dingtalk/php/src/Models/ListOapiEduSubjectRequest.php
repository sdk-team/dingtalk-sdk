...
class ListOapiEduSubjectRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiEduSubjectRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiEduSubjectParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
