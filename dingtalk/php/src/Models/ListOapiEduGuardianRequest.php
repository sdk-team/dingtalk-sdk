...
class ListOapiEduGuardianRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiEduGuardianRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiEduGuardianParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
