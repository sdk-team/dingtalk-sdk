...
class SendOapiEduGroupMsgRequest extends Model {
    ...
    /**
     * @param array $map
     * @return SendOapiEduGroupMsgRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = SendOapiEduGroupMsgParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
