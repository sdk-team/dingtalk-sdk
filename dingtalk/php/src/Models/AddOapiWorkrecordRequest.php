...
class AddOapiWorkrecordRequest extends Model {
    ...
    /**
     * @param array $map
     * @return AddOapiWorkrecordRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = AddOapiWorkrecordParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
