...
class GetCorpDeviceManageRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetCorpDeviceManageRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetCorpDeviceManageParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
