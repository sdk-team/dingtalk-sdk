...
class UpdateOapiExtcontactRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateOapiExtcontactRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateOapiExtcontactParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var UpdateOapiExtcontactParams
     */
    public $params;
