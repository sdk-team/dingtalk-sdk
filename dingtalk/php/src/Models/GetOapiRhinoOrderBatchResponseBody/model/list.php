...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\GetOapiRhinoOrderBatchResponseBody\model;
...
class list_ extends Model {
    protected $_name = [
        ...
        'bizIdDtechCategory' => 'biz_id_dtech_category',
        'bizIdDtechCategoryName' => 'biz_id_dtech_category_name',
        'bizIdDtechPkg' => 'biz_id_dtech_pkg',
        'colorId' => 'color_id',
    ...
    public function toMap() {
        ...
        if (null !== $this->bizIdDtechCategory) {
            $res['biz_id_dtech_category'] = $this->bizIdDtechCategory;
        }
        if (null !== $this->bizIdDtechCategoryName) {
            $res['biz_id_dtech_category_name'] = $this->bizIdDtechCategoryName;
        }
        if (null !== $this->bizIdDtechPkg) {
            $res['biz_id_dtech_pkg'] = $this->bizIdDtechPkg;
        }
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['biz_id_dtech_category'])){
            $model->bizIdDtechCategory = $map['biz_id_dtech_category'];
        }
        if(isset($map['biz_id_dtech_category_name'])){
            $model->bizIdDtechCategoryName = $map['biz_id_dtech_category_name'];
        }
        if(isset($map['biz_id_dtech_pkg'])){
            $model->bizIdDtechPkg = $map['biz_id_dtech_pkg'];
        }
    ...
    /**
     * @description 数字工艺品类id
     * @var string
     */
    public $bizIdDtechCategory;

    /**
     * @description 数字工艺品类名称
     * @var string
     */
