...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\CreateOapiRhinoMosExecPerformBatchResponseBody;
...
class model extends Model {
    ...
    /**
     * @description 工序类型code
     * @var string
     */
    public $processTypeCode;

    /**
     * @description 工序处理结束时间
     * @var string
     */
    public $processingEndTime;

    /**
     * @description 工序处理开始时间
     * @var string
     */
