...
class SimplelistCorpRoleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return SimplelistCorpRoleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = SimplelistCorpRoleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
