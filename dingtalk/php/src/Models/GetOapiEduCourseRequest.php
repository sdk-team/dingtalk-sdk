...
class GetOapiEduCourseRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduCourseRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduCourseParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
