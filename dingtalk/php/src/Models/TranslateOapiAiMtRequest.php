...
class TranslateOapiAiMtRequest extends Model {
    ...
    /**
     * @param array $map
     * @return TranslateOapiAiMtRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = TranslateOapiAiMtParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
