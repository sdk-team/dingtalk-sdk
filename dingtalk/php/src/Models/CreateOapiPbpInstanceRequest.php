...
class CreateOapiPbpInstanceRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateOapiPbpInstanceRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateOapiPbpInstanceParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CreateOapiPbpInstanceParams
     */
    public $params;
