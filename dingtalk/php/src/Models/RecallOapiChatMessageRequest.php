...
class RecallOapiChatMessageRequest extends Model {
    ...
    /**
     * @param array $map
     * @return RecallOapiChatMessageRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = RecallOapiChatMessageParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var RecallOapiChatMessageParams
     */
    public $params;
