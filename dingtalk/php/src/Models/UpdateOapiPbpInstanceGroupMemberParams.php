...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\UpdateOapiPbpInstanceGroupMemberParams\syncParam;

class UpdateOapiPbpInstanceGroupMemberParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return UpdateOapiPbpInstanceGroupMemberParams
     */
