...
class GetOapiEduSubjectRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduSubjectRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduSubjectParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
