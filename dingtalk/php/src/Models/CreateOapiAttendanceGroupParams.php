...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\CreateOapiAttendanceGroupParams\group;

class CreateOapiAttendanceGroupParams extends Model {
    protected $_name = [
        'group' => 'group',
        'opUserid' => 'op_userid',
    ];
    ...
    /**
     * @param array $map
     * @return CreateOapiAttendanceGroupParams
     */
