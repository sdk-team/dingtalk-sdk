...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\ListbypageOapiUserResponseBody\userlist;

class ListbypageOapiUserResponseBody extends Model {
    protected $_name = [
        'errcode' => 'errcode',
        'errmsg' => 'errmsg',
        'hasMore' => 'hasMore',
    ...
    /**
     * @param array $map
     * @return ListbypageOapiUserResponseBody
     */
