...
class CheckuidOapiMicroappRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CheckuidOapiMicroappRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CheckuidOapiMicroappParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CheckuidOapiMicroappParams
     */
    public $params;
