...
class PredeductOapiCateringRequest extends Model {
    ...
    /**
     * @param array $map
     * @return PredeductOapiCateringRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = PredeductOapiCateringParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var PredeductOapiCateringParams
     */
    public $params;
