...
class ConvertOapiImChatCidRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ConvertOapiImChatCidRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ConvertOapiImChatCidParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ConvertOapiImChatCidParams
     */
    public $params;
