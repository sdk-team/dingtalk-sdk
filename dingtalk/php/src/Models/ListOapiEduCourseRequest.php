...
class ListOapiEduCourseRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiEduCourseRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiEduCourseParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
