...
class InstallOapiChatbotRequest extends Model {
    ...
    /**
     * @param array $map
     * @return InstallOapiChatbotRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = InstallOapiChatbotParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
