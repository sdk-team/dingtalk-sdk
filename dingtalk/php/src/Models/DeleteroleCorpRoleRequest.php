...
class DeleteroleCorpRoleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return DeleteroleCorpRoleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = DeleteroleCorpRoleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
