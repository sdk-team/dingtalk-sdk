...
class DeleteOapiProcessRequest extends Model {
    ...
    /**
     * @param array $map
     * @return DeleteOapiProcessRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = DeleteOapiProcessParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
