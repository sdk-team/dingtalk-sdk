...
class GetOapiHireNavigationRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiHireNavigationRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiHireNavigationParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetOapiHireNavigationParams
     */
    public $params;
