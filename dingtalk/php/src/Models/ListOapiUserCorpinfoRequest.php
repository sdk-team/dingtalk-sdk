...
class ListOapiUserCorpinfoRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiUserCorpinfoRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiUserCorpinfoParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ListOapiUserCorpinfoParams
     */
    public $params;
