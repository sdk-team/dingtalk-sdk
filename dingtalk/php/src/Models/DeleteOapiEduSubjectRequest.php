...
class DeleteOapiEduSubjectRequest extends Model {
    ...
    /**
     * @param array $map
     * @return DeleteOapiEduSubjectRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = DeleteOapiEduSubjectParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var DeleteOapiEduSubjectParams
     */
    public $params;
