...
class UpdateCorpDeviceNickRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateCorpDeviceNickRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateCorpDeviceNickParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var UpdateCorpDeviceNickParams
     */
    public $params;
