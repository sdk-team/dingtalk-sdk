...
class GetOapiInactiveUserV2Request extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiInactiveUserV2Request
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiInactiveUserV2Params::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetOapiInactiveUserV2Params
     */
    public $params;
