...
class QueryOapiEduHomeworkRequest extends Model {
    ...
    /**
     * @param array $map
     * @return QueryOapiEduHomeworkRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = QueryOapiEduHomeworkParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var QueryOapiEduHomeworkParams
     */
    public $params;
