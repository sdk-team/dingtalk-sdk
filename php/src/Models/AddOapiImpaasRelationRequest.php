...
class AddOapiImpaasRelationRequest extends Model {
    ...
    /**
     * @param array $map
     * @return AddOapiImpaasRelationRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = AddOapiImpaasRelationParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var AddOapiImpaasRelationParams
     */
    public $params;
