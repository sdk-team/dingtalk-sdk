...
class UpdateOapiWorkspaceRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateOapiWorkspaceRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateOapiWorkspaceParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
