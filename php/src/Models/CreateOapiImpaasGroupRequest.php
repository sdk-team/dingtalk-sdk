...
class CreateOapiImpaasGroupRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateOapiImpaasGroupRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateOapiImpaasGroupParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CreateOapiImpaasGroupParams
     */
    public $params;
