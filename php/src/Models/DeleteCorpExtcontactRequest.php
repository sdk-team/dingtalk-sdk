...
class DeleteCorpExtcontactRequest extends Model {
    ...
    /**
     * @param array $map
     * @return DeleteCorpExtcontactRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = DeleteCorpExtcontactParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var DeleteCorpExtcontactParams
     */
    public $params;
