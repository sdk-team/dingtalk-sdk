...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\FinishOapiRhinoMosExecPerformConditionalParams\entityCondition;

class FinishOapiRhinoMosExecPerformConditionalParams extends Model {
    protected $_name = [
        'tenantId' => 'tenant_id',
    ...
    /**
     * @param array $map
     * @return FinishOapiRhinoMosExecPerformConditionalParams
     */
