...
class GetOapiMaterialNewsRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiMaterialNewsRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiMaterialNewsParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
