...
class SetuserlistIsvCallRequest extends Model {
    ...
    /**
     * @param array $map
     * @return SetuserlistIsvCallRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = SetuserlistIsvCallParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
