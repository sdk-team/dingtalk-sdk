...
class ListOapiEduClassRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiEduClassRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiEduClassParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
