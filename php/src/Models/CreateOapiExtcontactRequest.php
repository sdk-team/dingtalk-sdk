...
class CreateOapiExtcontactRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateOapiExtcontactRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateOapiExtcontactParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CreateOapiExtcontactParams
     */
    public $params;
