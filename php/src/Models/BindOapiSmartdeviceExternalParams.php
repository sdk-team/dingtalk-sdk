...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\BindOapiSmartdeviceExternalParams\deviceBindReqVo;

class BindOapiSmartdeviceExternalParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return BindOapiSmartdeviceExternalParams
     */
