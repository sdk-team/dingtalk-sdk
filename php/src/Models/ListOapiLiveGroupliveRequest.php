...
class ListOapiLiveGroupliveRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListOapiLiveGroupliveRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListOapiLiveGroupliveParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ListOapiLiveGroupliveParams
     */
    public $params;
