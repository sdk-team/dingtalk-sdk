...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\DelemployeedismissionandhandoverCorpHrmEmployeeParams\dismissionInfoWithHandOver;

class DelemployeedismissionandhandoverCorpHrmEmployeeParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return DelemployeedismissionandhandoverCorpHrmEmployeeParams
     */
