...
class DelOapiImpaasRelationRequest extends Model {
    ...
    /**
     * @param array $map
     * @return DelOapiImpaasRelationRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = DelOapiImpaasRelationParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var DelOapiImpaasRelationParams
     */
    public $params;
