...
class GetOapiInactiveUserRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiInactiveUserRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiInactiveUserParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
