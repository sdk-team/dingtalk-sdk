...
class StatisticsOapiReportRequest extends Model {
    ...
    /**
     * @param array $map
     * @return StatisticsOapiReportRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = StatisticsOapiReportParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var StatisticsOapiReportParams
     */
    public $params;
