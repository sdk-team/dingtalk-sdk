...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\SaveflowOapiRhinoMosLayoutOperationdefParams;

use AlibabaCloud\Tea\Model;

use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\SaveflowOapiRhinoMosLayoutOperationdefParams\operationDefs\operationExecutorAssigns;
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\SaveflowOapiRhinoMosLayoutOperationdefParams\operationDefs\workUnits;

class operationDefs extends Model {
    protected $_name = [
    ...
    public function validate() {
        Model::validateRequired('autoSchedule', $this->autoSchedule, true);
        Model::validateRequired('enterCondition', $this->enterCondition, true);
        Model::validateRequired('name', $this->name, true);
        Model::validateRequired('operationExternalId', $this->operationExternalId, true);
        Model::validateRequired('operationType', $this->operationType, true);
        Model::validateRequired('sectionCode', $this->sectionCode, true);
        Model::validateRequired('sectionName', $this->sectionName, true);
        Model::validateRequired('skip', $this->skip, true);
        Model::validateRequired('stdCost', $this->stdCost, true);
    }
    ...
    /**
     * @description 后续工序ID列表（只用于返回，保存请设置nextVirtualIds）
     * @var array
     */
    ...
    /**
     * @description 工序唯一ID（保存时已存在则复用，不存在会自增）
     * @var int
     */
    public $operationUid;
