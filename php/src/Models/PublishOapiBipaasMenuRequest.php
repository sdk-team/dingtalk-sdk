...
class PublishOapiBipaasMenuRequest extends Model {
    ...
    /**
     * @param array $map
     * @return PublishOapiBipaasMenuRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = PublishOapiBipaasMenuParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var PublishOapiBipaasMenuParams
     */
    public $params;
