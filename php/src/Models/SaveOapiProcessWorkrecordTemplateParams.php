...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\SaveOapiProcessWorkrecordTemplateParams\saveProcessRequest;

class SaveOapiProcessWorkrecordTemplateParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return SaveOapiProcessWorkrecordTemplateParams
     */
