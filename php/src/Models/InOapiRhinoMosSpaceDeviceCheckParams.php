...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\InOapiRhinoMosSpaceDeviceCheckParams\request;

class InOapiRhinoMosSpaceDeviceCheckParams extends Model {
    protected $_name = [
        'request' => 'request',
    ];
    ...
    /**
     * @param array $map
     * @return InOapiRhinoMosSpaceDeviceCheckParams
     */
