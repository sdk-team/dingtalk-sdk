...
class CreateCorpExtcontactRequest extends Model {
    ...
    /**
     * @param array $map
     * @return CreateCorpExtcontactRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = CreateCorpExtcontactParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var CreateCorpExtcontactParams
     */
    public $params;
