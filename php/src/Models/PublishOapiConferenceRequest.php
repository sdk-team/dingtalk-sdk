...
class PublishOapiConferenceRequest extends Model {
    ...
    /**
     * @param array $map
     * @return PublishOapiConferenceRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = PublishOapiConferenceParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var PublishOapiConferenceParams
     */
    public $params;
