...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\UpdateOapiAttendanceGroupParams;
...
class group extends Model {
    ...
    public function validate() {
        ...
        Model::validateRequired('locationOffset', $this->locationOffset, true);
