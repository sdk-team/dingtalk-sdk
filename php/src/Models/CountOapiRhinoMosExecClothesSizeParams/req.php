...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\CountOapiRhinoMosExecClothesSizeParams;
...
class req extends Model {
    ...
    public function validate() {
        Model::validateRequired('clothesStatusList', $this->clothesStatusList, true);
