...
class GetrolegroupCorpRoleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetrolegroupCorpRoleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetrolegroupCorpRoleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetrolegroupCorpRoleParams
     */
    public $params;
