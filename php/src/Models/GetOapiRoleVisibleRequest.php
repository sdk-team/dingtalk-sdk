...
class GetOapiRoleVisibleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiRoleVisibleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiRoleVisibleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
