...
class GetOapiEduSubDataRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiEduSubDataRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiEduSubDataParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
