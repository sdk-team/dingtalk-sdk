...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\ListOapiCrmObjectdataResponseBody\resultList;

class ListOapiCrmObjectdataResponseBody extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return ListOapiCrmObjectdataResponseBody
     */
