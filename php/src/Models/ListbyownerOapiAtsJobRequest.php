...
class ListbyownerOapiAtsJobRequest extends Model {
    ...
    /**
     * @param array $map
     * @return ListbyownerOapiAtsJobRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = ListbyownerOapiAtsJobParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var ListbyownerOapiAtsJobParams
     */
    public $params;
