...
class UpdateroleOapiRoleRequest extends Model {
    ...
    /**
     * @param array $map
     * @return UpdateroleOapiRoleRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = UpdateroleOapiRoleParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
