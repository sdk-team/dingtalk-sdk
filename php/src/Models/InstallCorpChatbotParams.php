...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\InstallCorpChatbotParams\chatbotVo;

class InstallCorpChatbotParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return InstallCorpChatbotParams
     */
