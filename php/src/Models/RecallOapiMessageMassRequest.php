...
class RecallOapiMessageMassRequest extends Model {
    ...
    /**
     * @param array $map
     * @return RecallOapiMessageMassRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = RecallOapiMessageMassParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var RecallOapiMessageMassParams
     */
    public $params;
