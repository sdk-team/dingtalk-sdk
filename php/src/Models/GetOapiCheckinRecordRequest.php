...
class GetOapiCheckinRecordRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GetOapiCheckinRecordRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GetOapiCheckinRecordParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GetOapiCheckinRecordParams
     */
    public $params;
