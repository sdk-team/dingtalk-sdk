...
class Get_by_mobileOapiUserRequest extends Model {
    ...
    /**
     * @param array $map
     * @return Get_by_mobileOapiUserRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = Get_by_mobileOapiUserParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var Get_by_mobileOapiUserParams
     */
    public $params;
