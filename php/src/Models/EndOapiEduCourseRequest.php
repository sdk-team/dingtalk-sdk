...
class EndOapiEduCourseRequest extends Model {
    ...
    /**
     * @param array $map
     * @return EndOapiEduCourseRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = EndOapiEduCourseParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
