...
class EnableOapiPbpInstanceRequest extends Model {
    ...
    /**
     * @param array $map
     * @return EnableOapiPbpInstanceRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = EnableOapiPbpInstanceParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var EnableOapiPbpInstanceParams
     */
    public $params;
