...
use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\RegistekmsOapiIsvOpenencryptParams\topKmsMeta;

class RegistekmsOapiIsvOpenencryptParams extends Model {
    protected $_name = [
    ...
    /**
     * @param array $map
     * @return RegistekmsOapiIsvOpenencryptParams
     */
