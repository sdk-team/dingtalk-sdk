...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\GetOapiKacV2DatavVideoconfResponseBody;
...
class result extends Model {
    protected $_name = [
        ...
        'joinVideoConfLenMin' => 'join_video_conf_len_min',
        'startVideoConfLenMin' => 'start_video_conf_len_min',
    ];
    ...
    public function toMap() {
        ...
        if (null !== $this->joinVideoConfLenMin) {
            $res['join_video_conf_len_min'] = $this->joinVideoConfLenMin;
        }
        if (null !== $this->startVideoConfLenMin) {
            $res['start_video_conf_len_min'] = $this->startVideoConfLenMin;
        }
        return $res;
    }
    /**
    ...
    public static function fromMap($map = []) {
        ...
        if(isset($map['join_video_conf_len_min'])){
            $model->joinVideoConfLenMin = $map['join_video_conf_len_min'];
        }
        if(isset($map['start_video_conf_len_min'])){
            $model->startVideoConfLenMin = $map['start_video_conf_len_min'];
        }
        return $model;
    }
    /**
    ...
    /**
     * @description 视频会议企业的累积消耗时长（即参会者入会总时长，且算到发起企业上）(分钟)
     * @var string
     */
    public $joinVideoConfLenMin;

    /**
     * @description 成功发起视频会议时长（分钟）
     * @var string
     */
    public $startVideoConfLenMin;
