...
namespace AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\MigrateOapiWorkspaceTaskParams;

use AlibabaCloud\Tea\Model;

use AlibabaCloud\SDK\SDK_DATA_1598238000612\Models\MigrateOapiWorkspaceTaskParams\task\extension;
...
class task extends Model {
    ...
    /**
     * @description 此字段用于数据迁移的场景，表示任务在源系统中的唯一ID，ISV接入时必填，用于跳转至各自的任务详情页
     * @var string
     */
    public $sourceId;
    ...
    /**
     * @description 任务参与者列表, 传staffId（工号）
     * @var array
     */
