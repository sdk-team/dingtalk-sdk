...
class GettodonumOapiProcessRequest extends Model {
    ...
    /**
     * @param array $map
     * @return GettodonumOapiProcessRequest
     */
    public static function fromMap($map = []) {
        ...
        if(isset($map['params'])){
            $model->params = GettodonumOapiProcessParams::fromMap($map['params']);
        }
        return $model;
    }
    public $headers;
    ...
    /**
     * @var GettodonumOapiProcessParams
     */
    public $params;
